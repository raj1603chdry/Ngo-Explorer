...
<head>
   <meta charset="UTF-8" />
    ...
    <title>Welcome To NGOExplorer</title>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/raj.css" />
...
<body>
    ...
    <section id="front-page">
        <ul class="cb-slideshow">
            <li><span>img1</span></li>
            <li><span>img2</span></li>
            <li><span>img3</span></li>
            <li><span>img4</span></li>
            <li><span>img5</span></li>
            <li><span>img6</span></li>
        </ul>
    </section>
    <!--menu bar-->
    <section id="navbar">
