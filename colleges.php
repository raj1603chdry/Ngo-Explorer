...
?>
        ...
        <head>
            ...
            <meta name="description" content="List Of NGOs" />
            <meta name="keywords" content="NGOs, NGOExplorer, NGO" />
            <meta name="author" content="Raj Choudhary, Abhiraj Chaudhary" />
        ...
        <div id="main" role="main">
            <section class="slider">
                <div class="flexslider">
                    <ul class="slides">
                        <li>
                            <img src="assets/images/s2_slide.jpg" />
                        </li>
                        <li>
                            <img src="assets/images/s3_slide.jpg" />
                        </li>
                        <li>
                            <img src="assets/images/h1_slide.jpg" />
                        </li>
                        <li>
                            <img src="assets/images/h2_slide.jpg" />
                        </li>
                        <li>
                            <img src="assets/images/g2_slide.jpg" />
                        </li>
                        <li>
                            <img src="assets/images/g3_slide.jpg" />
                        </li>
                    </ul>
                </div>
            </section>
        ...
        $('.flexslider').flexslider({
            ...
            <div id="sb-search" class="sb-search">
                <form method="POST" action="colleges.php">
                    <input class="sb-search-input" placeholder="Enter the ngo name ..." type="text" value="" name="search" id="search">
            ...
            <section class="grid-wrap">
                <ul class="grid swipe-down" id="grid">
                    <?php while($row = mysqli_fetch_assoc($result))  { $id=$row['clg_id']; $college=$row['college_name']; ?>
                        <li>
                            <a href="review.php?id=<?php echo urlencode($id);?>&college<?php echo urlencode($college); ?>"><img src="img/<?php echo $id;?>_1.jpg" width="290" height="450" id="<?php echo $row['college_name'];?>">
...
<!--         <div class="container">
    ...
    var college = ['GOONJ', 'SMILE FOUNDATION', 'HELPAGE INDIA'];
