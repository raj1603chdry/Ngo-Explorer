            ...
            <div class="col-sm-8">
                <div class="row">
                    <div class="col-sm-12" style="height: 550px; overflow: scroll; text-align: justify;">
                        ...
                        <p style="font-family: 'Roboto', sans-serif;color: white;">
                            Questions about the Terms of Service should be sent to us at NGOExplorer@gmail.com.
                        </p>
                    </div>
                </div>
            </div>
